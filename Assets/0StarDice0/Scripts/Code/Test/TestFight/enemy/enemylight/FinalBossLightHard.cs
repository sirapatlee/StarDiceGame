...
public class FinalBossLightHard : MonoBehaviour
{
    [Header("Player Setup")]
...
StartCoroutine(DelayedEnemyTurn()); 
 ...
 return; // ⭐️ สำคัญมาก: ออกจากฟังก์ชันนี้ทันที (ไม่ไปเปิดปุ่มด้านล่าง)
    ...
    float CalculateSkill2Score() // สกิล 2: โจมตี (Damage)
    {
       ...
       float score = 75; // ค่าพื้นฐานของดาเมจ
      ...
      float CalculateSkill5Score() 
    {
       ...
       float score = 90; // ค่าพื้นฐานของดาเมจ
    ...
    {
        enemyHPBar.maxValue = 380;
        enemyHPBar.value = enemyHP;
        enemyHPText.text = $"HP: {enemyHP}/380";
    }
