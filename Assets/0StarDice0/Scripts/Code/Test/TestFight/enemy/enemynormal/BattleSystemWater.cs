...
public class BattleSystemWater : MonoBehaviour
{
    [Header("Player Setup")]
...
StartCoroutine(DelayedEnemyTurn()); 
 ...
 GameEventManager.TryAddCount1(1);
    ...
    void ChooseAndExecuteBestEnemyMove(int basicAttackDamage)
    {
        ...
        {
            Debug.Log("AI เลือก: Skill 3 (shield)");
            EnemySkill3();
        }
    ...
    float CalculateSkill3Score() // สกิล 3 shield
    {
    ...
    {
        enemyHPBar.maxValue = 120;
        enemyHPBar.value = enemyHP;
        enemyHPText.text = $"HP: {enemyHP}/120";
    }
...
void EnemyUseSkill1() //<--สกิล 1 ศัตรู
    {
        ...
        {
            damage /= 2;
            Debug.Log("ผู้เล่นเป็นธาตุดิน ดาเมจถูกลดครึ่งหนึ่ง");
        }
        ...
        Debug.Log("ศัตรูใช้ waterfall ทำดาเมจ " + damage);
    }
    ...
    void EnemySkill3() //<--สกิล 3 ศัตรู
    {
        ...
        Debug.Log("ศัตรูใช้สกิล 3 ลดพลังโจมตีผู้เล่น 50% ");
