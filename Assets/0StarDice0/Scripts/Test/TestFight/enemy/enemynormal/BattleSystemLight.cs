...
public class BattleSystemLight : MonoBehaviour
{
    [Header("Player Setup")]
...
public PlayerState player;
    ...
    public Image showImage;
     ...
     public ItemID Knightsword = ItemID.KnightSword; // สมมติกล่องนี้ดรอปดาบไฟ
...
StartCoroutine(DelayedEnemyTurn()); 
 ...
 GameEventManager.TryAddCount1(1);
    ...
    float CalculateSkill3Score() // สกิล 3 buff*3
    {
    ...
    {
        enemyHPBar.maxValue = 140;
        enemyHPBar.value = enemyHP;
        enemyHPText.text = $"HP: {enemyHP}/140";
    }
...
void EnemyUseSkill1() //<--สกิล 1 ศัตรู
    {
     ...
     if (selectedPlayer.elementType == ElementType.Dark)
        {
            damage *= 2;
            Debug.Log("ผู้เล่นเป็นธาตุมืด ดาเมจคูณ 2");
        }
