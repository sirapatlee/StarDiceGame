...
public class BossWind : MonoBehaviour
{
    [Header("Player Setup")]
        ...
        void PlaySoundEffect(int index)
{
  ...
  void UseSkill(SkillData skill)
    ...
    public int nextLevelToUnlock = 4;
...
StartCoroutine(DelayedEnemyTurn()); 
 ...
 return; // ⭐️ สำคัญมาก: ออกจากฟังก์ชันนี้ทันที (ไม่ไปเปิดปุ่มด้านล่าง)
    ...
    {
        enemyHPBar.maxValue = 300;
        enemyHPBar.value = enemyHP;
        enemyHPText.text = $"HP: {enemyHP}/300";
    }
 ...
 void EnemyUseSkill1() //<--สกิล 1 ศัตรู
    {
        ...
        Debug.Log("ศัตรูใช้ ลม ทำดาเมจ " + damage);
    }
